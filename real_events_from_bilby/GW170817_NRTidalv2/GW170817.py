...
bilby_datadumps_path = "/home/thibeau.wouters/jim_pbilby_samples/datadumps/"
...
for ifo in ifos:
    ...
    bilby_file = os.path.join(bilby_datadumps_path, f"GW170817_NRTidalv2/{name}_data.npz")
    ifo_data = np.load(bilby_file)
    
    freqs, real_strain, imag_strain = ifo_data["freqs"], ifo_data["real_strain"], ifo_data["imag_strain"]
...
ref_params = {
    ...
    's1_z': 0.04999456,
    's2_z': -0.02761281,
    'lambda_1': 23.22880524,
    'lambda_2': 371.52994482,
    'd_L': 15.19457679,
    't_c': 0.00087638,
    'phase_c': 4.11326745,
    'iota': 1.90898925,
...
jim.sample(jax.random.PRNGKey(965342))
