...
export this_dir=$events_dir/GW170817_TaylorF2
...
cp $this_dir/GW170817_snellius.py "$TMPDIR"
cp $events_dir/utils_plotting.py "$TMPDIR"
# cp -r $HOME/gw-datasets/GW170817/GW170817* "$TMPDIR"

# Run the script
python $this_dir/GW170817_snellius.py
